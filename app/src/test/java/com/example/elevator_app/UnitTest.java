...
public class UnitTest {
    ...
    public void testElevatorAlertClass() {
        ...
        ElevatorAlert newAlert = new ElevatorAlert("headline", "short description", "full description", "begin date time", "end date time");
        ...
        assertEquals(newAlert.getEndDateTime(), "end date time");
    }

    @Test
    public void testStationClass(){
        Station newStation = new Station( "name", true, new String[]{"str1", "str2"});
